...
Requires and comes with MySQL Connector/Python v1.1 and later:
    http://dev.my_mysql.com/downloads/connector/python/
"""
...
try:
    import my_mysql.connector
    from my_mysql.connector.conversion import MySQLConverter, MySQLConverterBase
    from my_mysql.connector.catch23 import PY2
except ImportError as err:
    from django.core.exceptions import ImproperlyConfigured
    raise ImproperlyConfigured(
        "Error loading my_mysql.connector module: {0}".format(err))

try:
    version = my_mysql.connector.__version_info__[0:3]
except AttributeError:
    from my_mysql.connector.version import VERSION
    version = VERSION[0:3]
...
if version < (1, 1):
    ...
    raise ImproperlyConfigured(
        ...
        "is required; you have %s" % my_mysql.connector.__version__)
...
from my_mysql.connector.django.client import DatabaseClient
from my_mysql.connector.django.creation import DatabaseCreation
from my_mysql.connector.django.introspection import DatabaseIntrospection
from my_mysql.connector.django.validation import DatabaseValidation
from my_mysql.connector.django.features import DatabaseFeatures
from my_mysql.connector.django.operations import DatabaseOperations
if django.VERSION >= (1, 7):
    from my_mysql.connector.django.schema import DatabaseSchemaEditor


DatabaseError = my_mysql.connector.DatabaseError
IntegrityError = my_mysql.connector.IntegrityError
NotSupportedError = my_mysql.connector.NotSupportedError
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_connection_params(self):
        ...
        kwargs['client_flags'] = [
            ...
            my_mysql.connector.constants.ClientFlag.FOUND_ROWS,
        ]
        try:
    ...
    def get_new_connection(self, conn_params):
        ...
        cnx = my_mysql.connector.connect(**conn_params)
    ...
    def mysql_version(self):
        ...
        temp_conn = my_mysql.connector.connect(**config)
