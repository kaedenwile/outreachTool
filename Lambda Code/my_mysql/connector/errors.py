...
def custom_error_exception(error=None, exception=None):
    ...
    Examples:
        ...
        my_mysql.connector.custom_error_exception(
            1028, my_mysql.connector.DatabaseError)

        # Or using a dictionary:
        my_mysql.connector.custom_error_exception({
            1028: my_mysql.connector.DatabaseError,
            1029: my_mysql.connector.OperationalError,
            })
...
def get_mysql_exception(errno, msg=None, sqlstate=None):
    ...
    my_mysql.connector.custom_error_exception() function.
