...
class FabricMySQLConnection(FabricConnection):
    ...
    """
    def __init__(self, fabric, host, port=MYSQL_FABRIC_PORT['my_mysql'],
                 connect_attempts=_CNX_ATTEMPT_MAX,
                 connect_delay=_CNX_ATTEMPT_DELAY):
        """Initialize"""
...
class MySQLFabricConnection(object):
    ...
    def _connect(self):
        ...
        while counter != attempts:
            ...
            try:
                self._mysql_cnx = my_mysql.connector.connect(**dbconfig)
            except Error as exc:
                if counter == attempts:
    ...
    def handle_mysql_error(self, exc):
        ...
        This method takes a my_mysql.connector.errors.Error exception
